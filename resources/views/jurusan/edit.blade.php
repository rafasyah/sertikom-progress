                ...
                <div class="p-6">
                    <form action="{{ route('jurusan.update', $jurusan) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="kode_jurusan" name="kode_jurusan" type="text" class="mt-1 block w-full" :value="old('kode_jurusan', $jurusan->kode_jurusan)" required />
                            <x-input-error :messages="$errors->get('kode_jurusan')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="nama_jurusan" :value="__('Nama Jurusan')" />
                            <x-text-input id="nama_jurusan" name="nama_jurusan" type="text" class="mt-1 block w-full" :value="old('nama_jurusan', $jurusan->nama_jurusan)" required />
