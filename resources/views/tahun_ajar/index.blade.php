<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
            ...
            <a href="{{ route('tahun-ajar.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200 w-full sm:w-auto text-center">
                Tambah Tahun Ajar
            </a>
            @endif
        </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        ...
                                        <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $tahunAjar->nama_tahun_ajar }}</h3>
                                    </div>
