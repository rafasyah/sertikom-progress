                ...
                <div class="p-6">
                    <form action="{{ route('siswa.update', $siswa) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="alamat" name="alamat" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" rows="3" required>{{ old('alamat', $siswa->alamat) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="kelas_id" name="kelas_id" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                ...
                                @foreach($kelas as $kela)
                                    <option value="{{ $kela->id }}" {{ old('kelas_id', $siswa->kelas_id) == $kela->id ? 'selected' : '' }}>{{ $kela->nama_kelas }}</option>
                                @endforeach
                            </select>
