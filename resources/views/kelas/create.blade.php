                ...
                <div class="p-6">
                    <form action="{{ route('kelas.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nama_kelas" name="nama_kelas" type="text" class="mt-1 block w-full" :value="old('nama_kelas')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="level_kelas" name="level_kelas" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                ...
                                <option value="X" {{ old('level_kelas') == 'X' ? 'selected' : '' }}>X</option>
                                <option value="XI" {{ old('level_kelas') == 'XI' ? 'selected' : '' }}>XI</option>
                                <option value="XII" {{ old('level_kelas') == 'XII' ? 'selected' : '' }}>XII</option>
                            </select>
