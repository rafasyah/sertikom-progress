<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
            ...
            <a href="{{ route('kelas.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full sm:w-auto text-center">
                Tambah Kelas
            </a>
            @endif
        </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        ...
                                        <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $kela->nama_kelas }}</h3>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            {{ $kela->jurusan->nama_jurusan }} • {{ $kela->tahun_ajar->nama_tahun_ajar }}
                                        </p>
                                    </div>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($kelas as $kela)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                        ...
                                        <td class="hidden sm:table-cell px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
